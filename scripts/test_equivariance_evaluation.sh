#!/bin/bash
#
# Test script for rotation equivariance evaluation
# Uses CPU and small number of batches for quick testing
#
# Usage:
#   ./scripts/test_equivariance_evaluation.sh [checkpoint_path]
#
...
OUTPUT_DIR="equivariance_test_results_$(date +%Y%m%d_%H%M%S)"
...
echo "=========================================="
echo "Rotation Equivariance Evaluation TEST"
echo "=========================================="
echo "Config: $CONFIG"
...
# Run evaluation
echo ""
echo "Step 1/3: Running evaluation..."
echo "----------------------------------------"
...
echo ""
echo "Step 3/3: Generating Latent Plots"
echo "=========================================="

# Run latent plotting
python scripts/plot_latents.py \
    --results-dir "$OUTPUT_DIR" \
    --batch-idx 0 \
    --sample-idx 0 \
    --num-samples "$NUM_SAMPLES" \
...
# Display aggregated metrics if jq is available
if command -v jq &> /dev/null; then
    ...
    echo "Aggregated Metrics (install jq for formatted output):"
    echo "----------------------------------------"
...
echo "=========================================="
echo "Next steps:"
echo "  1. Check visualizations in: $OUTPUT_DIR/plots"
echo "  2. Check latent plots in: $OUTPUT_DIR/latent_plots"
echo "  3. Review metrics in: $OUTPUT_DIR/aggregated_metrics.json"
echo "  4. For full evaluation, use: ./scripts/run_equivariance_evaluation.sh"
echo "=========================================="
